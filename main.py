...
with open('/home/srec/Desktop/FaceRPI/it_device/configs/threshold.txt', 'r') as f:
    thresh = float(f.read())
...
if __name__ == '__main__':
    ...
    img = Image.open("/home/srec/Desktop/FaceRPI/it_device/data/Visgenix Logo-01.png")
