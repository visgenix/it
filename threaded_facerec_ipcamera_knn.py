...
def Train_Recognize(thresh):
    repo_path = '/home/srec/Desktop/FaceRPI/it_device'
    ...
    while 1 > 0:
        ...
        if get_time()=="09:00" or get_time()=="20:50":
            print('time up')
            if get_time()=="09:00":
                break
            elif get_time()=="20:50":
                storage.child("/Attendance/"+get_date()+"_2.csv").put('/home/srec/Desktop/FaceRPI/data/'+get_date()+".csv")
            break
